...
public class Profesores {
	...
	@Column(unique = true, nullable= false)//Para asegurar que no exista dos veces el mismo correo o esté en blanco.
	...
	public List<Practica> getPactica() {
		return pactica;
	}
